...
export const generateChatResponse = async (req, res) => {
    const { conversation, educationLevel, teachingStyle } = req.body;
    try {
        ...
        // Implementasi Fase 2: Parameter Kreatif (Dynamic System Instruction)
        let sysInstruction = "Anda adalah EduBot, asisten pendidikan cerdas yang menggunakan bahasa Indonesia.";
